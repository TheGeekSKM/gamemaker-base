...
/// @function WithTagged(_tag, _lambda)
...
function WithTagged(tag, lambda) {
...
/// @function ChangeSprite(_newSpriteIndex)
...
/// @returns {Real}
function CenterYPos(_inst = self) {
	return _inst.bbox_top + (_inst.bbox_bottom - _inst.bbox_top)/2;
}

/// @function PointInBounds(_pX, _pY)
